...
public class IActivityManagerProxy extends ClassInvocationStub {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Exception {
            ...
            if (auth instanceof String) {
                ...
                if (auth.equals("settings") || auth.equals("media") || auth.equals("telephony")) {
                    ...
                    ProviderInfo providerInfo = EliteInstaller.getBPackageManager().resolveContentProvider((String) auth, FileUtils.FileMode.MODE_IWUSR, BActivityThread.getUserId());
                    ...
                    if (BActivityThread.getAppPid() != -1) {
                        ...
                        args[getUserIndex()] = EliteInstaller.getHostUserId();
                    }
    ...
    public static class RegisterReceiverWithFeature extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            return hookRegisterReceiver(who, method, args);
        }
    }
    ...
    private static Object hookRegisterReceiver(Object who, Method method, Object[] args) throws Throwable {
        MethodParameterUtils.replaceFirstAppPkg(args);
        int receiverIndex = -1;
        for (int i = 0; i < args.length; i++) {
        ...
        for (int i = 0; i < args.length; i++) {
            ...
            if (o instanceof String) {
                String s = (String) o;
                if (s.startsWith("android.permission.") || s.contains(".permission.")) {
                    args[i] = null;
                    break;
                }
            }
