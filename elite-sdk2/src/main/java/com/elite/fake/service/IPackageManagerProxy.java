...
public class IPackageManagerProxy extends BinderInvocationStub {
    ...
    public static class GetPackageInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            PackageInfo result;
            if (packageName != null && packageName.equals(EliteInstaller.getHostPkg())) {
                result = (PackageInfo) method.invoke(who, args);
            } else if (GmsCore.isGoogleAppOrService(packageName) || GmsCore.setGoogleAppOrService(packageName)) {
                result = (PackageInfo) method.invoke(who, args);
            } else {
                PackageInfo packageInfo = EliteInstaller.getBPackageManager()
                        .getPackageInfo(packageName, flags, BActivityThread.getUserId());
                if (packageInfo != null) {
                    result = packageInfo;
                } else if (AppSystemEnv.isOpenPackage(packageName)) {
                    result = (PackageInfo) method.invoke(who, args);
                } else {
                    try {
                        result = (PackageInfo) method.invoke(who, args);
    ...
    public static class QueryIntentActivities extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Intent intent = (Intent) args[0];
            String resolvedType = args.length > 1 && args[1] instanceof String ? (String) args[1] : null;
    ...
    public static class GetPackageUid extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (pkg != null) {
                try {
                    if (EliteInstaller.getBPackageManager().getApplicationInfo(
